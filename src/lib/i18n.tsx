...
const messages: Record<Exclude<SupportedLocale, "system">, Record<MessageKey, string>> = {
  en: {
    ...
    refresh_interval_copy: "Choose how frequently FollowBar checks follower counts.",
    notifications: "Notifications",
    notifications_copy: "Notify you when tracked accounts cross saved milestones.",
    launch_at_login: "Launch at Login",
    launch_at_login_copy: "Open FollowBar automatically when you sign in to macOS.",
    language: "Language",
  ...
  "zh-CN": {
    ...
    refresh_interval_copy: "设置 FollowBar 检查粉丝数变化的频率。",
    notifications: "通知",
    notifications_copy: "当账号达到保存的里程碑时通知你。",
    launch_at_login: "登录时启动",
    launch_at_login_copy: "登录 macOS 后自动打开 FollowBar。",
    language: "语言",
