...
- 公开页面 + runtime（App 会使用本机 runtime 执行公开页面抓取）
...
Threads 账号使用公开页面 + runtime 获取数据，推荐输入方式是账号主页链接或 handle。
...
Instagram 账号使用公开页面 + runtime 获取数据，推荐输入方式是账号主页链接或 handle。
...
知乎账号使用公开页面 + runtime 获取数据，推荐输入方式是个人主页链接或 profile slug。
